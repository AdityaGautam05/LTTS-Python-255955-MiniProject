...
class Grid:
    ...
    def __init__(self, rows, cols, width, height, lvl):
        self.rows = rows
        self.cols = cols
...
class Cube:
    ...
    def draw(self, win):
        ...
        if self.temp != 0 and self.value == 0:
            ...
            text = fnt.render(str(self.value), 1,
...
def redraw_window(win, board, time, strikes):
    win.fill((40, 40, 40))  # background color
    # Draw time
    fnt = pygame.font.SysFont("corbel", 40)
    text = fnt.render("Time: " + format_time(time),
                      1, (200, 200, 200))  # Time color
